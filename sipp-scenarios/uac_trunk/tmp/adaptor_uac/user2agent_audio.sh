...
#sipp 10.60.28.104:5060 -sf user2agent_audio.xml -inf user2agent.csv -m 1 -l 1 -r 1 -rp 1000 
sipp 49.213.78.92:5060 -sf user2agent_audio.xml -inf user2agent_ext.csv -m 1 -l 1 -r 1 -rp 1000 
